...
try {
	...
	$retAll		= 	Doctrine_Query::create()->select()->from('Funcionario f')
					->where($where);
	
	$retLimit	= 	Doctrine_Query::create()->select()->from('Funcionario f')
