...
<div id="body">
	<div class="block big"><!-- Block Begin -->
		<div class="titlebar">
			<h3>Tipo de Lançamento - Cadastrar</h3>
		...
		<div class="block_cont">
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				...
				<div class="form_row radioui">
					<label>Tipo:</label>
					<div class="clear"></div>
					<input type="radio" id="tipo1" name="tipo" value="1" class="input validate[required]"><label for="tipo1">Crédito</label>
					<input type="radio" id="tipo0" name="tipo" value="0" class="input validate[required]"><label for="tipo0">Débito</label>
				</div>
