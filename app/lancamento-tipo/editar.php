...
<div id="body">
	<div class="block big"><!-- Block Begin -->
		<div class="titlebar">
			<h3>Tipo de Lançamento - Editar</h3>
		...
		<div class="block_cont">
			...
			try {
				...
				// Seleciona os dados
				$res = Doctrine_Core::getTable('LancamentoTipo')->find($_GET['id']);
			...
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="post" id="formPerfil">
				...
				<div class="form_row radioui">
					...
					?>
					<input type="radio" id="tipo1" name="tipo" value="1" class="input validate[required]" <?php echo $s1; ?>><label for="tipo1">Crédito</label>
					<input type="radio" id="tipo0" name="tipo" value="0" class="input validate[required]"  <?php echo $s0; ?>><label for="tipo0">Débito</label>
				</div>
