...
<div id="body">
	<div class="block big"><!-- Block Begin -->
		<div class="titlebar">
			<h3>Saida no Estoque - Cadastrar</h3>
		...
		<div class="block_cont">
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				<div class="form_row">
					...
					<input type="text" name="descricao" id="descricao" value="SAÍDA DE PRODUTO" class="input validate[required,maxSize[60]]" style="width: 380px; font-weight: bold" />
				</div>
...
<script type="text/javascript">
        ...
        $('#addMaterial').live('click', function() {
        	if($('#material').val()==''||$('#material').val()=='undefined'){
	            ...
	            $('<p><span id="IL_AD1" class="IL_AD"><b>Material:</b>  <input type="hidden" name="material_id[]" id="material_id[]" value="'+ material_id +'"> <input type ="text" name ="material[]" id="'+ material +'" value="'+ material +'"><b>Quantidade:</b> <input type ="text" name="quantidade[]" id="quantidade" value="'+quantidade+'"><b> <a href="#" src="" class="remNew">Remove</a> </span> </p>').appendTo(addDiv);
