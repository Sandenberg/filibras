		...
		<div class="block_cont">
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				...
				<div class="form_row">
					...
					<input type="text" name="nome_completo" id="nome_completo" class="input validate[maxSize[150]]" style="width: 400px;" />
				</div>
				...
				<div class="form_row">
					<label>Cep:</label>
					<input type="text" name="cep" id="cep" class="input " style="width: 65px;" />
				</div>
				...
				<div class="form_row">
					...
					<textarea name="obs" id="obs" class="textarea" style="width: 730px;" rows="6" ></textarea>
				</div>
				...
				<div class="form_row">
					<label>Nome:</label>
					<input type="text" name="nome_contato" id="nome_contato" class="input validate[maxSize[60]]" style="width: 440px;" />
				</div>
