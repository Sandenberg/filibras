	...
	<div class="block big">
		...
		<div class="block_cont">
			...
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				...
				<div class="form_row">
					<label>Cep:</label>
					<input type="text" name="cep" id="cep" class="input " style="width: 65px;" value="<?php echo $res->cep; ?>" />
				</div>
			...
			<div class="form_row">
					...
					<textarea name="obs" id="obs" class="textarea" style="width: 730px;" rows="6" ><?php echo $res->obs; ?></textarea>
				</div>
				...
				<div class="form_row">
					...
					<label>Nome:</label>
					<input type="text" name="nome_contato" id="nome_contato" class="input validate[maxSize[60]]" style="width: 440px;" value="<?php echo $res->nome_contato; ?>" />
				</div>
				
				<div class="form_row">
					<label>E-mail:</label>
					<input type="text" name="email_contato" id="email_contato" class="input validate[maxSize[100],custom[email]]" style="width: 270px;" value="<?php echo $res->email_contato; ?>" />
				</div>
