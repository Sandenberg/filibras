...
<div id="body">
	<div class="block big"><!-- Block Begin -->
		<div class="titlebar">
			<h3>Financeiro - Crédito - Cadastrar</h3>
 ...
 -->
				...
				<div class="form_row">
					...
					<select name="tipo_id" id="tipo_id" class="select validate[required]" style="width: 215px;">
						...
						try {
							$where = "id = 29 or id = 30 or id = 28 or id = 46";
...
<!-- 
				...
				<div class="form_row venc">
					...
					<input type="text" name="lancamento" id="lancamento" class="input validate[maxSize[60],custom[dateBR]]" style="width: 102px;" />
				</div>
