	...
	<div class="block big"><!-- Block Begin -->
        ...
        <div class="block_cont">
            ...
            <form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="post" id="formPerfil">
                ...
                <h4>TOTAL DE MAQUINAS ALUGADAS POR MODELO </h4>
                <hr />
                <div class="clear"></div>
                ...
                while ( $retTotal = mysql_fetch_assoc($exe)){
                    ...
                    ?>
                        ...
                        <div class="form_row" style="cursor: pointer; border: 1px #ccc solid; margin-right: 40px;" onclick="location.href= '<?php echo URL_ADMIN ?>relatorio-loc-model/clientes?id=<?php echo $retTotal['id_eq'] ?>'">
                            <div class="form_row">
                ...
                <h4>TOTAL DE MAQUINAS ALUGADAS: <?php echo $total ?> </h4>
