$(document).ready(function(){
        ...
        $('.data-table').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": URL_ADMIN+"action.php?model=debito&action=listar",
                "iDisplayLength": 10,
                "aLengthMenu": [10, 25, 50, 100, 200],
                "aoColumns": [
                        { "mDataProp": "data_vencimento", "sName": "data_vencimento", "bSearchable": false },                                  
                        { "mDataProp": "Beneficiario.nome", "sName": "b.nome" },                             
                        { "mDataProp": "nfrb", "sName": "nfrb", "bSortable": false, "bSearchable": false  },                    
