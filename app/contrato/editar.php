		...
		<div class="block_cont">
			...
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="post" id="formPerfil">
				...
				<div class="form_row radioui">
				    ...
				    <input type="radio" id="tipo4" name="tipo" value="4" class="validate[required]" <?php echo $t4; ?> /><label for="tipo4">Equipamento do Cliente</label>
				</div>
				...
				<div class="form_row">
				<label>Valor:</label> 
					<input type="text" name="valor" id="valor" class="input" value="<?php echo number_format($res->valor, 4, ',', '.') ?>" style="width: 100px;" />
				</div>	
