...
try {
	...
	// Tratamento de dados
	$_POST['equipamento_id'] 	= isset($_POST['equipamento_id'])&&$_POST['equipamento_id']!=''?$_POST['equipamento_id']:0;
	$_POST['condicao_id'] 		= isset($_POST['condicao_id'])&&$_POST['condicao_id']!=''?$_POST['condicao_id']:0;
	...
	// Update
	$objCondicao					= Doctrine_Core::getTable('EquipamentoCondicao')->findOneByEquipamentoIdAndCondicaoId($_POST['equipamento_id'],$_POST['condicao_id']);
