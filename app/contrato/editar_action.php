...
try {
	...
	$_POST['valor']		                = isset($_POST['valor'])&&$_POST['valor']>0?(float) str_replace(",", ".", $_POST['valor']):null;
	...
	$objContrato->garantia 					= $_POST['garantia'];
	...
	Util::regLog('Contrato', $objContrato->id, 'editou', $objContrato->Cliente->nome_completo);
} catch(Exception $e){
