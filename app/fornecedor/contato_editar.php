...
<div id="body">
	<div class="block big"><!-- Block Begin -->
		...
		try {
			...
			$obj = Doctrine_Core::getTable('FornecedorResponsavel')->find($_GET['id']);
			$res = 'Fornecedor - '.$obj->Fornecedor->nome_completo.' - Contato - Editar';
		...
		<div class="block_cont">
			...
			try {
				...
				// Seleciona os dados
				$res = Doctrine_Core::getTable('FornecedorResponsavel')->find($_GET['id']);
			...
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="post" id="formPerfil">
				...
				<input type="hidden" name="fornecedor_id" value="<?php echo $res->fornecedor_id; ?>" />
