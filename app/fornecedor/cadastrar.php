		...
		<div class="block_cont">
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				...
				<div class="form_row radioui">
					...
					<input type="checkbox" id="tipo_fornecimento0" name="tipo_fornecimento[]" value="1" class="validate[required]" checked="checked" /><label for="tipo_fornecimento0">Suprimentos</label> 
					<input type="checkbox" id="tipo_fornecimento1" name="tipo_fornecimento[]" value="2" class="validate[required]" /><label for="tipo_fornecimento1">Peças</label>
					<input type="checkbox" id="tipo_fornecimento2" name="tipo_fornecimento[]" value="3" class="validate[required]" /><label for="tipo_fornecimento2">Multifuncional</label> 
					<input type="checkbox" id="tipo_fornecimento3" name="tipo_fornecimento[]" value="4" class="validate[required]" /><label for="tipo_fornecimento3">Diversos</label>
				...
				<span class="juridica">
					<div class="form_row">
						<label>CNPJ:</label> 
						<input type="text" name="cnpj" id="cnpj" class="input " style="width: 156px;" />
					</div>
				</span>
