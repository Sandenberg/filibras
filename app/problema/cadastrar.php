...
<div id="body">
	<div class="block big"><!-- Block Begin -->
		<div class="titlebar">
			<h3>Problema e Solução - Cadastrar</h3>
		...
		<div class="block_cont">
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				<div class="form_row">
					...
					<input type="text" name="titulo" id="titulo" class="input validate[required,maxSize[60]]" style="width: 380px;" />
				</div>
				
				<div class="form_row radioui">
					<label>Status:</label>
					<div class="clear"></div>
					<input type="radio" id="status1" name="status" value="1" class="input validate[required]"><label for="status1">Solucionado</label>
					<input type="radio" id="status0" name="status" value="0" class="input validate[required]"><label for="status0">Em aberto</label>
				</div>
				...
				<div class="form_row">
					<label>Causa:</label>
					<textarea name="causa" id="causa" class="textarea" cols="90" rows="10" ></textarea>
				</div>
				...
				<div class="form_row">
					<label>Solução:</label>
					<textarea name="solucao" id="solucao" class="textarea" cols="90" rows="10" ></textarea>
				</div>
				<br />
