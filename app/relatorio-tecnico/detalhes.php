<?php ini_set('memory_limit', -1); // defined('_SYSTEM') or exit('Direct access to the script is not allowed!'); ?>
<div id="body">
            ...
            <form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="post" id="formPerfil">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <?php if($_POST['tipo'] == 'ordem'){ ?>
                        <th>
                            <label><b>Finalizado:</b></label>
                        </th>
                        <th>
                            <label><b>Por:</b></label>
                        </th>
                ...
                if($tipo == "tecnico")
                    ...
                    $where .= isset($_POST['usuario_id'])&&$_POST['usuario_id']!=''?" and fo.audit = '".$_POST['usuario_id']."'":' and fo.audit <> "" or fo.audit is not null';
                ...
                foreach ($retAll as $objLancamento) {
                    ...
                    // if(isset($objLancamento->FinalizarOrdemServico[0]->audit)&&$objLancamento->FinalizarOrdemServico[0]->audit!=''&&$objLancamento->FinalizarOrdemServico[0]->audit==$objLancamento->audt){
                    ...
                    if($_POST['tipo'] != 'ordem'){
                        ...
                        if(isset($objLancamento->FinalizarOrdemServico[0]->audit)&&$objLancamento->FinalizarOrdemServico[0]->audit!=''){
                            $resUsuario = Doctrine_Core::getTable('Usuario')->find($objLancamento->FinalizarOrdemServico[0]->audit);
                            $usunomeFinalizado = isset($resUsuario->nome)&&$resUsuario->nome!=''?$resUsuario->nome:'-';
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <?php if($_POST['tipo'] == 'ordem'){ ?>
                                <td>
                                    <div style="width: 100px;"><?php echo $finalizado; ?></div>
                                </td>

                                <td>
                                    <div style="width: 100px;"><?php echo $usunomeFinalizado; ?></div>
                                </td>
                            <?php } ?>
                        </tr>
