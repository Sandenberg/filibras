	...
	<div class="block big">
		...
		<div class="block_cont">
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form">
				<input type="hidden" id="numequip" value="0">
				<div class="form_row radioui">
                    ...
                    <input type="radio" id="tipo_ordemserv8" name="tipo_ordemserv" value="8" class="validate[required]" /><label for="tipo_ordemserv8">Acesso Remoto</label>
                    <input type="radio" id="tipo_ordemserv9" name="tipo_ordemserv" value="9" class="validate[required]" /><label for="tipo_ordemserv9">Atendimento Avulso</label>
				</div>
				<div class="clear"></div>
				<div class="form_row">
					<label>Cliente:</label>
                ...
                <div class="form_row radioui">
				    ...
				    <input type="radio" id="tipo_cliente4" name="tipo_cliente" value="4" class="validate[required]" /><label for="tipo_cliente4">Equipamento do Cliente</label>  
				</div>
				<div class="form_row">
					&nbsp;&nbsp;&nbsp;<input type="button" class="submit" id="btnBuscar" value="Buscar" style="margin-left: 20px;" />
				</div>
		...
		<span>
               <div class="clear"></div>
                ...
                <span class="avulso">
					...
					<div class="form_row">
                        <label>Localização:</label>
                        <input type="text" name="observacoes" id="observacoes" class="input validate[required]" style="width: 500px;" />
                    </div>
			...
			<div class="clear"></div>
		       <span class="troca">
				...
				<div class="clear"></div>
				<div class="form_row">
					<input type="button" class="submit submitform" value="Salvar" />
				</div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#addmanutecao').live('click', function() {
        	if($('#equipamento_id').val()==''||$('#equipamento_id').val()=='undefined'){
        ...
        $('#addtoner').live('click', function() {
        	...
        	if(($('#equipamento_id').val()==''||$('#equipamento_id').val()=='undefined')&&$('#tipo_cliente4').prop('checked')!=true){
				alert("Adicione um equipamento!");
        	}
        	else{
	            var equipamento = $('#equipamento_id option:selected').text();
        ...
        $('#adddiversos').live('click', function() {
        	if($('#equipamento_id').val()==''||$('#equipamento_id').val()=='undefined'){
	            ...
	            var equipamento_nome = $('#equipamento_id option:selected').attr('nome');
	            var equipamento_id = $('#equipamento_id option:selected').val();
	            var equipamento_id2 = $('#equipamento_id2').val();
	            var serial = $('#serial').val();
	            var localizacao = $('#loc').val();
